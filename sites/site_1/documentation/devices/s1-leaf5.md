...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s1-leaf6_Ethernet1 | *trunk | *- | *- | *['MLAG'] | 1 |
| Ethernet2 | S1-SPINE1_Ethernet9 | *trunk | *20 | *- | *- | 2 |
| Ethernet3 | S1-SPINE2_Ethernet9 | *trunk | *20 | *- | *- | 2 |
| Ethernet6 | MLAG_PEER_s1-leaf6_Ethernet6 | *trunk | *- | *- | *['MLAG'] | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_s1-leaf6_Po1 | switched | trunk | - | - | ['MLAG'] | - | - | - | - |
